...
import { Configuration, IConfigurationFactory } from '../../../../../app/areas/configuration';
import { IEditorService, ISourceFileProxy } from '../../../../../app/areas/document-handling';
import { IElementCollectionFactory } from '../../../../../app/areas/element-creation';
import { IElementSortingService } from '../../../../../app/areas/element-sorting';
import {
  FileArrangementService
} from '../../../../../app/areas/file-arrangement/services/implementation';
...
describe('FileArrangementService', () => {
  ...
  describe('Calling the arrange method', () => {
    ...
    describe('Requests sorting', () => {
      it('Once', async () => {
        elementSortingServiceMock.verify(f => f.sortElementsByConfiguration(moq.It.IsAny<ElementCollection>(), moq.It.IsAny<Configuration>()), moq.Times.Once());
      });
